  ...
  return (
    <div className="w-full min-h-screen flex flex-col  bg-[#F9DBDB]">
      <div className="w-full h-full flex flex-auto ">
        <div className="w-[240px] min-h-[90.5vh] flex-none border border-blue-500">
          <SidebarLeft />
        </div>
        ...
        {isShowRightSidebar && (
          <div className="w-[330px] hidden 1600:flex animate-slide-left flex-none border-green-500">
            <SidebarRight />
          </div>
        )}
      </div>
